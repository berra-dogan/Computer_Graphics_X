...
int example5(){
    ...
    stbi_write_png("output_images/example5.png", W, H, 3, &image[0], 0);
...
int example6(){
    ...
    stbi_write_png("output_images/example6.png", W, H, 3, &image[0], 0);
...
int example7(){
    ...
    stbi_write_png("output_images/example7.png", W, H, 3, &image[0], 0);
