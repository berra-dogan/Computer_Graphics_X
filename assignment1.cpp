...
int example1() {
    ...
    stbi_write_png("example1.png", W, H, 3, &image[0], 0);
...
int example2() {
    ...
    stbi_write_png("example2.png", W, H, 3, &image[0], 0);
...
int example3() {
    ...
    stbi_write_png("example3.png", W, H, 3, &image[0], 0);
...
int example_mesh(){
    ...
    stbi_write_png("example_mesh.png", W, H, 3, &image[0], 0);
